...
local library = {design = getgenv().design == "uwuware" and "uwuware" or "kali", tabs = {}, draggable = true, flags = {}, title = 'nightside.net | ' .. getgenv().version, open = false, popup = nil, instances = {}, connections = {}, options = {}, notifications = {}, tabSize = 0, theme = {}, foldername = 'nightsideConfigs', fileext = '.night'}
...
setclipboard('discord.gg/qHG9QfsnUz')
end})
