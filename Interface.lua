...
local library = {tabs = {}, draggable = true, flags = {}, title = 'nightside.net', open = false, mousestate = true, popup = nil, instances = {}, connections = {}, options = {}, notifications = {}, tabSize = 0, theme = {}, foldername = 'nightsideConfigs', fileext = '.night'}
